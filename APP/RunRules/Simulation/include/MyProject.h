// NOTE:
// NOTE:
// NOTE: This file is copied from maxeler gui - https://maxeler.mi.sanu.ac.rs/#/login; it may not be included if neccessary somewhere in the code
// NOTE:
// NOTE:
